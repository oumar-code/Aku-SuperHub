...
#
# Aku-SuperHub — Regional analytics & fleet management service
# Multi-stage build:
#   builder   — installs all deps
...
LABEL org.opencontainers.image.source="https://github.com/oumar-code/Aku-SuperHub"
LABEL org.opencontainers.image.version="0.1.1"
LABEL org.opencontainers.image.description="Aku-SuperHub — regional analytics service for the Aku Platform"
